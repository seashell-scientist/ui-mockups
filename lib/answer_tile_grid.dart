...
Expanded(
  ...
  ''', //ah can't have repeat colors, only one per designated area
                        ...
                        children: [
                          // Using NamedAreaGridPlacement constructor
                          // Alternatively, an extension method on Widget is available
                          AnswerTile('https://m.media-amazon.com/images/M/MV5BMTY1MjgzODIwNF5BMl5BanBnXkFtZTcwNTM2NzExMw@@._V1_UY317_CR10,0,214,317_AL_.jpg').inGridArea('blue'),
                          //Container(color: Colors.blue).inGridArea('blue'),
                          AnswerTile('https://tse2.mm.bing.net/th?id=OIP.y9CLuLh4R0QSwLIIWNOLNAHaHD&pid=Api').inGridArea('red'),
                          AnswerTile('https://tse3.mm.bing.net/th?id=OIP.1jLZAIx9nzOn4EeGpFLZWAHaJw&pid=Api').inGridArea('green'),
                          AnswerTile('https://upload.wikimedia.org/wikipedia/en/c/c6/NeoTheMatrix.jpg').inGridArea('yellow'),
                          //Image.network('https://m.media-amazon.com/images/M/MV5BMTY1MjgzODIwNF5BMl5BanBnXkFtZTcwNTM2NzExMw@@._V1_UY317_CR10,0,214,317_AL_.jpg'), //wes anderson
                        ],
                      ),
                    ),
                  ),
...
class AnotherClass extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ServerIpText(serverIP: "127.0.0.1");
  }
}*/
